...
class Contact extends Component {
    ...
    // use of curried function in JavaScript
    handleBlur = (field) => (evt) => {
        // set everything else in touched to be the same, except for [field] 
        this.setState({
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        // for each character, check at least one char is @
    ...
    render(){
        // render will be repeatedly called when the page needs to be rerendered, therefore check errors in render function
