...
class Header extends Component {
    ...
    constructor(props){
        ...
        //to give render function access to isNavOpen, have to bind it in constructor
        // alternatively, we can use arrow function in render
    ...
    render(){
        // expand="md" is for navbar to show full form for md to xl size
        return(
            <React.Fragment>
